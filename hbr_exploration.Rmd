...
```
The MSPE indicates there is about a 9.34 cm^2 prediction error from the model. To note, this regression was performed on a very small dataset and is meant to be shown as an example of the workflow for the simple linear regression process.
